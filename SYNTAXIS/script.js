...
const activities = [
    {
        ...
        description: "Seminar kesehatan bulanan dengan topik terkini",
        image: "seminar.jpg"
    },
    {
        id: 2,
        title: "Vaksinasi COVID-19",
        description: "Program vaksinasi untuk masyarakat",
        image: "vaksin.jpg"
    },
    {
        id: 3,
        title: "Medical Check-Up",
        description: "Paket pemeriksaan kesehatan lengkap",
        image: "checkup.jpg"
    }
];
...
// Populate specialist options based on hospital selection
function updateSpecialists() {
    const hospitalSelect = document.getElementById('hospitalSelect');
    const specialistSelect = document.getElementById('specialistSelect');
    
    // Clear current options
    specialistSelect.innerHTML = '<option value="">Semua Spesialis</option>';
    
    if (hospitalSelect.value) {
        // Add specialists based on selected hospital
        const specialists = getSpecialists(hospitalSelect.value);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add event listeners
    const hospitalSelect = document.getElementById('hospitalSelect');
    hospitalSelect.addEventListener('change', updateSpecialists);
    
    // Initialize specialists
    updateSpecialists();
});

// Helper function to get specialists (mock data)
function getSpecialists(hospitalId) {
    return [
        { id: 1, name: "Dokter Spesialis Anak" },
        { id: 2, name: "Dokter Spesialis Penyakit Dalam" },
        { id: 3, name: "Dokter Spesialis Bedah" },
        { id: 4, name: "Dokter Spesialis Kandungan" }
    ];
}
...
function handleAdminLogin() {
    ...
    if (admin) {
        ...
        state.adminLoggedIn = true; // Set adminLoggedIn to true
...
function cancelAdminLogin() {
    ...
    state.adminLoggedIn = false; // Set adminLoggedIn to false
    renderApp();
}
